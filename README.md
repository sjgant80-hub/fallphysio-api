...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=fallphysio-api](https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallphysio-api)
...
- **Companion SDK** (`npm install @ai-native-solutions/fallphysio-api-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add fallphysio-api -- npx -y @ai-native-solutions/fallphysio-api-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/fallphysio-api-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallphysio-api
- **Live URL**: https://sjgant80-hub.github.io/fallphysio-api/
- **Source**: https://github.com/sjgant80-hub/fallphysio-api
